...
@class RTC_OBJC_TYPE(RTCAudioPlayerSource);
@protocol RTC_OBJC_TYPE(RTCAudioPlayerSourceDelegate);
...
- (RTC_OBJC_TYPE(RTCAudioPlayerSource) *)createAudioPlayerSourceWithSSRC:(int)ssrc sample:(int)sample delegate:(id<RTC_OBJC_TYPE(RTCAudioPlayerSourceDelegate)>)delegate;

- (void)addAudioPlayerSource:(RTC_OBJC_TYPE(RTCAudioPlayerSource) *)source;

- (void)removeAudioPlayerSource:(RTC_OBJC_TYPE(RTCAudioPlayerSource) *)source;
